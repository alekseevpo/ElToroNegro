# El Toro Negro - Investment Platform
...
📖 **Подробная инструкция:** [SETUP_MAC.md](./SETUP_MAC.md)
...
# Установите зависимости для контрактов
npm install

# Установите зависимости для фронтенда
cd frontend && npm install && cd ..

# Запустите локальную Hardhat сеть (в одном терминале)
npx hardhat node
